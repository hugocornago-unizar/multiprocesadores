...
00000000004010b0 <_start>:
  ...
  4010c1:	50                   	push   %rax
  4010c2:	54                   	push   %rsp
  4010c3:	49 c7 c0 70 14 40 00 	mov    $0x401470,%r8
  4010ca:	48 c7 c1 00 14 40 00 	mov    $0x401400,%rcx
...
0000000000401230 <init>:
  ...
  401237:	00 
  401238:	c5 fa 10 05 9c 0e 00 	vmovss 0xe9c(%rip),%xmm0        # 4020dc <__dso_handle+0xd4>
  40123f:	00 
{
...
00000000004012a0 <axpy>:
{
  ...
  4012a3:	bb 00 00 f0 00       	mov    $0xf00000,%ebx
{
  4012a8:	48 83 ec 10          	sub    $0x10,%rsp
    init();
  4012ac:	e8 7f ff ff ff       	call   401230 <init>
    start_t = get_wall_time();
  4012b1:	31 c0                	xor    %eax,%eax
  4012b3:	e8 f8 fe ff ff       	call   4011b0 <get_wall_time>
  4012b8:	c5 fa 10 0d 20 0e 00 	vmovss 0xe20(%rip),%xmm1        # 4020e0 <__dso_handle+0xd8>
  4012bf:	00 
  4012c0:	c5 fb 11 44 24 08    	vmovsd %xmm0,0x8(%rsp)
  ...
  4012cd:	00 00 00 
{
  ...
  4012d2:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
            y[i] = alpha*x[i] + y[i];
  4012d8:	c5 f2 59 80 80 50 40 	vmulss 0x405080(%rax),%xmm1,%xmm0
  4012df:	00 
        for (unsigned int i = 0; i < LEN; i++)
  4012e0:	48 83 c0 04          	add    $0x4,%rax
            y[i] = alpha*x[i] + y[i];
  4012e4:	c5 fa 58 80 7c 40 40 	vaddss 0x40407c(%rax),%xmm0,%xmm0
  4012eb:	00 
  4012ec:	c5 fa 11 80 7c 40 40 	vmovss %xmm0,0x40407c(%rax)
  4012f3:	00 
        for (unsigned int i = 0; i < LEN; i++)
  4012f4:	48 3d 00 10 00 00    	cmp    $0x1000,%rax
  4012fa:	75 dc                	jne    4012d8 <axpy+0x38>
        dummy(x, y, alpha);
  4012fc:	c5 f8 28 c1          	vmovaps %xmm1,%xmm0
  401300:	be 80 40 40 00       	mov    $0x404080,%esi
  401305:	bf 80 50 40 00       	mov    $0x405080,%edi
  40130a:	e8 87 fe ff ff       	call   401196 <dummy>
    for (unsigned int nl = 0; nl < NTIMES; nl++)
  40130f:	83 eb 01             	sub    $0x1,%ebx
  401312:	c5 fa 10 0d c6 0d 00 	vmovss 0xdc6(%rip),%xmm1        # 4020e0 <__dso_handle+0xd8>
  401319:	00 
  40131a:	75 b4                	jne    4012d0 <axpy+0x30>
    end_t = get_wall_time();
  40131c:	31 c0                	xor    %eax,%eax
  40131e:	e8 8d fe ff ff       	call   4011b0 <get_wall_time>
    results(end_t - start_t, "axpy");
  401323:	c5 fb 5c 44 24 08    	vsubsd 0x8(%rsp),%xmm0,%xmm0
  401329:	bf 2f 20 40 00       	mov    $0x40202f,%edi
  40132e:	e8 3d ff ff ff       	call   401270 <results>
    check(y);
  401333:	bf 80 40 40 00       	mov    $0x404080,%edi
  401338:	e8 b3 fe ff ff       	call   4011f0 <check>
}
  40133d:	48 83 c4 10          	add    $0x10,%rsp
  401341:	31 c0                	xor    %eax,%eax
  401343:	5b                   	pop    %rbx
  401344:	c3                   	ret
  401345:	66 66 2e 0f 1f 84 00 	data16 cs nopw 0x0(%rax,%rax,1)
  40134c:	00 00 00 00 

0000000000401350 <axpy_intr_SSE>:
{
  401350:	53                   	push   %rbx
    init();
  401351:	31 c0                	xor    %eax,%eax
    start_t = get_wall_time();
  401353:	bb 00 00 f0 00       	mov    $0xf00000,%ebx
{
  401358:	48 83 ec 10          	sub    $0x10,%rsp
    init();
  40135c:	e8 cf fe ff ff       	call   401230 <init>
    start_t = get_wall_time();
  401361:	31 c0                	xor    %eax,%eax
  401363:	e8 48 fe ff ff       	call   4011b0 <get_wall_time>
  401368:	c4 e2 79 18 0d 6f 0d 	vbroadcastss 0xd6f(%rip),%xmm1        # 4020e0 <__dso_handle+0xd8>
  40136f:	00 00 
  401371:	c5 fb 11 44 24 08    	vmovsd %xmm0,0x8(%rsp)
    for (unsigned int nl = 0; nl < NTIMES; nl++)
  401377:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
  40137e:	00 00 
{
  401380:	31 c0                	xor    %eax,%eax
...
_mm_mul_ps (__m128 __A, __m128 __B)
{
  ...
  401388:	c5 f0 59 80 80 50 40 	vmulps 0x405080(%rax),%xmm1,%xmm0
  40138f:	00 
        for (unsigned int i = 0; i < LEN; i+= SSE_LEN)
  401390:	48 83 c0 10          	add    $0x10,%rax
  return (__m128) ((__v4sf)__A + (__v4sf)__B);
  401394:	c5 f8 58 80 70 40 40 	vaddps 0x404070(%rax),%xmm0,%xmm0
  40139b:	00 
...
{
  *(__m128 *)__P = __A;
  40139c:	c5 f8 29 80 70 40 40 	vmovaps %xmm0,0x404070(%rax)
  4013a3:	00 
  4013a4:	48 3d 00 10 00 00    	cmp    $0x1000,%rax
  4013aa:	75 dc                	jne    401388 <axpy_intr_SSE+0x38>
        dummy(x, y, alpha);
  4013ac:	c5 fa 10 05 2c 0d 00 	vmovss 0xd2c(%rip),%xmm0        # 4020e0 <__dso_handle+0xd8>
  4013b3:	00 
  4013b4:	be 80 40 40 00       	mov    $0x404080,%esi
  4013b9:	bf 80 50 40 00       	mov    $0x405080,%edi
  4013be:	e8 d3 fd ff ff       	call   401196 <dummy>
    for (unsigned int nl = 0; nl < NTIMES; nl++)
  4013c3:	83 eb 01             	sub    $0x1,%ebx
  4013c6:	c5 f8 28 0d 12 0d 00 	vmovaps 0xd12(%rip),%xmm1        # 4020e0 <__dso_handle+0xd8>
  4013cd:	00 
  4013ce:	75 b0                	jne    401380 <axpy_intr_SSE+0x30>
  end_t = get_wall_time();
  4013d0:	31 c0                	xor    %eax,%eax
  4013d2:	e8 d9 fd ff ff       	call   4011b0 <get_wall_time>
  results(end_t - start_t, "axpy_intr_SSE");
  4013d7:	c5 fb 5c 44 24 08    	vsubsd 0x8(%rsp),%xmm0,%xmm0
  4013dd:	bf 34 20 40 00       	mov    $0x402034,%edi
  4013e2:	e8 89 fe ff ff       	call   401270 <results>
  check(y);
  4013e7:	bf 80 40 40 00       	mov    $0x404080,%edi
  4013ec:	e8 ff fd ff ff       	call   4011f0 <check>
}
  4013f1:	48 83 c4 10          	add    $0x10,%rsp
  4013f5:	31 c0                	xor    %eax,%eax
  4013f7:	5b                   	pop    %rbx
  4013f8:	c3                   	ret
  4013f9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)

0000000000401400 <__libc_csu_init>:
  401400:	f3 0f 1e fa          	endbr64
  401404:	41 57                	push   %r15
  401406:	49 89 d7             	mov    %rdx,%r15
  401409:	41 56                	push   %r14
  40140b:	49 89 f6             	mov    %rsi,%r14
  40140e:	41 55                	push   %r13
  401410:	41 89 fd             	mov    %edi,%r13d
  401413:	41 54                	push   %r12
  401415:	4c 8d 25 cc 29 00 00 	lea    0x29cc(%rip),%r12        # 403de8 <__frame_dummy_init_array_entry>
  40141c:	55                   	push   %rbp
  40141d:	48 8d 2d cc 29 00 00 	lea    0x29cc(%rip),%rbp        # 403df0 <__do_global_dtors_aux_fini_array_entry>
  401424:	53                   	push   %rbx
  401425:	4c 29 e5             	sub    %r12,%rbp
  401428:	48 83 ec 08          	sub    $0x8,%rsp
  40142c:	e8 cf fb ff ff       	call   401000 <_init>
  401431:	48 c1 fd 03          	sar    $0x3,%rbp
  401435:	74 1f                	je     401456 <__libc_csu_init+0x56>
  401437:	31 db                	xor    %ebx,%ebx
  401439:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
  401440:	4c 89 fa             	mov    %r15,%rdx
  401443:	4c 89 f6             	mov    %r14,%rsi
  401446:	44 89 ef             	mov    %r13d,%edi
  401449:	41 ff 14 dc          	call   *(%r12,%rbx,8)
  40144d:	48 83 c3 01          	add    $0x1,%rbx
  401451:	48 39 dd             	cmp    %rbx,%rbp
  401454:	75 ea                	jne    401440 <__libc_csu_init+0x40>
  401456:	48 83 c4 08          	add    $0x8,%rsp
  40145a:	5b                   	pop    %rbx
  40145b:	5d                   	pop    %rbp
  40145c:	41 5c                	pop    %r12
  40145e:	41 5d                	pop    %r13
  401460:	41 5e                	pop    %r14
  401462:	41 5f                	pop    %r15
  401464:	c3                   	ret

0000000000401465 <.annobin___libc_csu_fini.start>:
  401465:	66 66 2e 0f 1f 84 00 	data16 cs nopw 0x0(%rax,%rax,1)
  40146c:	00 00 00 00 

0000000000401470 <__libc_csu_fini>:
  401470:	f3 0f 1e fa          	endbr64
  401474:	c3                   	ret

Disassembly of section .fini:

0000000000401478 <_fini>:
  401478:	f3 0f 1e fa          	endbr64
  40147c:	48 83 ec 08          	sub    $0x8,%rsp
  401480:	48 83 c4 08          	add    $0x8,%rsp
  401484:	c3                   	ret
