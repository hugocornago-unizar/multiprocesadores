...
00000000004012a0 <axpy>:
{
  ...
  4012a5:	48 83 e4 e0          	and    $0xffffffffffffffe0,%rsp
    init();
...
{
  4012bb:	48 83 ec 20          	sub    $0x20,%rsp
    init();
  4012bf:	e8 6c ff ff ff       	call   401230 <init>
    start_t = get_wall_time();
  4012c4:	31 c0                	xor    %eax,%eax
  4012c6:	e8 e5 fe ff ff       	call   4011b0 <get_wall_time>
  4012cb:	c4 e2 7d 18 0d 0c 0e 	vbroadcastss 0xe0c(%rip),%ymm1        # 4020e0 <__dso_handle+0xd8>
  4012d2:	00 00 
  4012d4:	c5 fb 11 45 e8       	vmovsd %xmm0,-0x18(%rbp)
  ...
  4012d9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
{
  ...
  4012e2:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
            y[i] = alpha*x[i] + y[i];
  4012e8:	c5 f4 59 80 80 50 40 	vmulps 0x405080(%rax),%ymm1,%ymm0
  4012ef:	00 
  4012f0:	48 83 c0 20          	add    $0x20,%rax
  4012f4:	c5 fc 58 80 60 40 40 	vaddps 0x404060(%rax),%ymm0,%ymm0
  4012fb:	00 
  4012fc:	c5 fc 29 80 60 40 40 	vmovaps %ymm0,0x404060(%rax)
  401303:	00 
        for (unsigned int i = 0; i < LEN; i++)
  401304:	48 3d 00 10 00 00    	cmp    $0x1000,%rax
  40130a:	75 dc                	jne    4012e8 <axpy+0x48>
        dummy(x, y, alpha);
  40130c:	c5 fa 10 05 cc 0d 00 	vmovss 0xdcc(%rip),%xmm0        # 4020e0 <__dso_handle+0xd8>
  401313:	00 
  401314:	be 80 40 40 00       	mov    $0x404080,%esi
  401319:	bf 80 50 40 00       	mov    $0x405080,%edi
  40131e:	c5 f8 77             	vzeroupper
  401321:	e8 70 fe ff ff       	call   401196 <dummy>
    for (unsigned int nl = 0; nl < NTIMES; nl++)
  401326:	83 eb 01             	sub    $0x1,%ebx
  401329:	c5 fc 28 0d af 0d 00 	vmovaps 0xdaf(%rip),%ymm1        # 4020e0 <__dso_handle+0xd8>
  401330:	00 
  401331:	75 ad                	jne    4012e0 <axpy+0x40>
    end_t = get_wall_time();
  401333:	31 c0                	xor    %eax,%eax
  401335:	c5 f8 77             	vzeroupper
  401338:	e8 73 fe ff ff       	call   4011b0 <get_wall_time>
    results(end_t - start_t, "axpy");
  40133d:	c5 fb 5c 45 e8       	vsubsd -0x18(%rbp),%xmm0,%xmm0
  401342:	bf 2f 20 40 00       	mov    $0x40202f,%edi
  401347:	e8 24 ff ff ff       	call   401270 <results>
    check(y);
  40134c:	bf 80 40 40 00       	mov    $0x404080,%edi
  401351:	e8 9a fe ff ff       	call   4011f0 <check>
}
  401356:	48 83 c4 20          	add    $0x20,%rsp
  40135a:	31 c0                	xor    %eax,%eax
  40135c:	5b                   	pop    %rbx
  40135d:	41 5a                	pop    %r10
  40135f:	5d                   	pop    %rbp
...
_mm_store_ps (float *__P, __m128 __A)
{
  *(__m128 *)__P = __A;
  ...
  4013ca:	75 dc                	jne    4013a8 <axpy_intr_SSE+0x38>
        dummy(x, y, alpha);
  4013cc:	c5 fa 10 05 0c 0d 00 	vmovss 0xd0c(%rip),%xmm0        # 4020e0 <__dso_handle+0xd8>
  4013d3:	00 
  ...
  4013e6:	c5 f8 28 0d f2 0c 00 	vmovaps 0xcf2(%rip),%xmm1        # 4020e0 <__dso_handle+0xd8>
  4013ed:	00 
